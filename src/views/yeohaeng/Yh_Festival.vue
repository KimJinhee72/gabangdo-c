    ...
    <div id="festivalBanner">
      <div class="main-slide-list2">
        ...
        <div class="festival-month">
          <a :class="{ active: activeTab === 'CDF018.001' }" @click="changeTab('CDF018.001')">봄</a>
          <a class="festivalTab" :class="{ active: activeTab === 'CDF018.002' }" @click="changeTab('CDF018.002')">가을</a>
        </div>
        <!-- 이미지 Swiper (슬라이드 내용) 양쪽 빨간 페이지화살표 -->
        <div id="main-swiper" class="swiper mySwiper" :key="activeTab">
          <!-- 이미지 영역 -->
          <div class="swiper-wrapper">
            <div v-for="(festival, index) in festivalData[activeTab]" :key="index" class="swiper-slide">
              <div class="slide-wrap">
                <div class="left">
                  <svg xmlns="http://www.w3.org/2000/svg" width="40.002" height="39.998" viewBox="0 0 40.002 39.998">
                    <path id="합치기_22" data-name="합치기 22"
                      d="M0,40V12.666H0A12.665,12.665,0,0,1,12.666,0H40V12.666H12.668V40Z" :fill="activeTab === 'CDF018.001' ? '#ee2b2b' : 'yellow'
                        "></path>
                  </svg>
                  <div class="slide-info-wrap">
                    <div class="slide-info-title">
                      ...
                      <p></p>
                      <a v-if="festival.href" :href="festival.href" class="festi-more" target="_blank"
                        rel="noopener noreferrer">자세히 보기
                      </a>
                    </div>
                ...
                <div class="right">
                  <div class="right-thumb" :style="{ backgroundImage: `url(${festival.image})` }"
                    :aria-label="festival.alt" role="img"></div>
                </div>
              </div>
            </div>
          </div>
