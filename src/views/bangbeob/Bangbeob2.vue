...
<template>
  ...
  <div class="wrap_total">
    <div class="bb_inner div">
      <!-- 스텝퍼 네비바 -->
      <ProgressStepper v-show="showStepper" :steps="['전달방법', '요금안내', '무인보관', '유의사항']"
        :selectors="['#step1', '#step2', '#step3', '#step4']" :stepIndex="stepIndex" @go="scrollToSection"
            ...
            <div class="bb_luggageImgNotice">
              ...
              <div class="bb_luggage">
                ...
                <div class="bb_luggageimg">
                  <img src="/images/yr/page2/size4.png" class="bb_smaller" alt="sSize" />
                </div>
                <!-- 디테일 -->
              ...
              <div class="bb_luggage">
                ...
                <!-- 그림 -->
                <div class="bb_luggageimg">
                  <img src="/images/yr/page2/size4.png" alt="sSize" class="bb_smaller" />
                </div>
                <!-- 디테일 -->
                <div class="bb_luggagedetail">
    ...
    <!-- 무인보관함 위치안내 -->
    <div ref="step3" id="step3" class="step-container box">
        ...
        <div class="bb_container3">
          <div class="bb_inner bb_centerLine">
            ...
            <div class="bb_contain3Left">
              ...
              <p class="bb_sizeControll" style="color: red;">확인해주세요!</p>
            </div>
            ...
            <div class="bb_contain3Right">
              ...
              <div class="bb_noteTop">
                <ul class="bb_notice1">
                  <li>
                    <p style="color: red;">•</p> 보관 후 7일이 지난 물품은 관리자의 요청에 따라 이동될 수
                    있습니다.
                  </li>
                  <li>
                    <p style="color: red;">•</p> 보관함 이용 시 문이 잘 닫혔는지 꼭 확인해 주십시오. 문을
                    닫지 않아 발생하는 사고에 대한 책임을 지지 않습니다.
                  </li>
                  <li>
                    <p style="color: red;">•</p> 보관함보다 큰 물품, 귀중훔, 위험물, 동식물 등 부패할 수
                    있는 음식물은 보관할 수 없습니다.
                  </li>
                  <li>
                    <p style="color: red;">•</p> 천재지변, 전쟁, 사용자 과실, 기타 불가항력적인 이유로
                    발생하는 손해에 대해서는 책임을 지지 않습니다.
                  </li>
                  <li style="color: blue; margin-left: 20px;"> 단, 보관함 자체에 결함으로 발생한 과실에 대해서는 검증 후
                    보상해 드립니다.</li>
                  <li>
                    <p style="color: red;">•</p> 유사시 보관함 관리를 위해 보관함을 임시로 열어 점검할 수
                    있습니다.
                  </li>
                  <li>
                    <p style="color: red;">•</p> 보관함 이용중 발생한 문제는 고객센터 또는 현장 관리자에게
                    신고해 주십시오.
                  </li>
                </ul>
                <!-- 이용약관 상세보기 버튼 -->
              ...
              <div class="bb_noteDown2" style="list-style: none; padding-left: 0">
                ...
                <ul class="bb_notice2">
                  <li>
                    <span style="color: red;">•</span> 다른 사용자를 위해 보관된 물품은 꼭 찾아가 주세요.<br />
                    <span class="bb_Strong2">30일 이후로는 폐기 예정</span>
                    입니다.
                  </li>
                </ul>
              </div>
      ...
      <div class="bb_container5">
        ...
        <div class="bb_container4Bg">
          <div class="bb_inner">
            ...
            <div class="bb_notice">
              <div class="checkBlue">
                <img src="/images/geen/2/check 2.svg" alt="체크강조">
                <h3>기본 보상 제공</h3>
              </div>
              <p>
              ...
              <div class="checkBlue">
                <img src="/images/geen/2/check 2.svg" alt="체크강조">
                <h3 style="color: red;">보험 적용 제외 사항</h3>
              </div>
              <ul>
...
:deep(.bb_container5 .bb_innerBottom) {
...
:deep(.bb_container5 .bb_container4Bg .bb_inner .bb_notice) {
